    ...
    <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <div class="flex flex-wrap -m-2">
                ...
                <div class="p-2 w-full">
                    <x-primary-button
                        class="w-full flex justify-center mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">{{ (!isset($book->id) ? __('create') : __('edit')) }}</x-primary-button>
                </div>
            </div>
        </div>
    </div>
